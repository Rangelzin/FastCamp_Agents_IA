# Bibliotecas de terceiros para obter dados financeiros e manipular datas, além da biblioteca do ADK para criar agentes.
from datetime import datetime
import yfinance as yf
from google.adk.agents import Agent

# Ferramenta para obter o preço atual de uma ação, utilizando a biblioteca yfinance para acessar os dados financeiros.
